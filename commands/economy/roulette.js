...
.setColor("#FFFFFF")
.setDescription(`<a:money:732257497951502420> Specify an amount to gamble | m!roulette <color> <amount>`);
...
.setColor("#FFFFFF")
.setDescription(`<a:money:732257497951502420> Specify a color | Red [1.5x] Black [2x] Green [15x]`);
    ...
    if (random == 0 && colour == 2) { // Green
        ...
        .setColor("#FFFFFF")
        .setDescription(`<a:money:732257497951502420> You lost ${money} coins\n\nMultiplier: 0x`);
